...
```sh
# macOS / Linux
cp -R /path/to/agentchattr/templates/project /path/to/your-project/.agentchattr

# Windows (PowerShell)
Copy-Item -Recurse /path/to/agentchattr/templates/project /path/to/your-project/.agentchattr
```
